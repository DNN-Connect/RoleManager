...
namespace Connect.DNN.Modules.RoleManager.Common
{
    public class ContextHelper
    {
        ...
        {
            ClientResourceManager.RegisterStyleSheet(Page, string.Format("~/DesktopModules/MVC/Connect/RoleManager/css/{0}", cssFile), 70, "", name, version);
        }
        public void AddCss(string cssFile)
        {
            ClientResourceManager.RegisterStyleSheet(Page, string.Format("~/DesktopModules/MVC/Connect/RoleManager/css/{0}", cssFile));
        }
        ...
        {
            ClientResourceManager.RegisterScript(Page, string.Format("~/DesktopModules/MVC/Connect/RoleManager/js/{0}", scriptName), 70, "", name, version);
        }
        public void AddScript(string scriptName)
        {
            ClientResourceManager.RegisterScript(Page, string.Format("~/DesktopModules/MVC/Connect/RoleManager/js/{0}", scriptName));
        }
        public void AddModuleScript()
        {
            DotNetNuke.Framework.ServicesFramework.Instance.RequestAjaxScriptSupport();
            AddReactJs();
            AddScript("rolemanager.js");
        }
        public void AddReactJs()
        {
            AddScript("react.min.js", "react", "15.0.1");
            AddScript("react-dom.min.js", "react-dom", "15.0.1");
        }       
        #endregion
